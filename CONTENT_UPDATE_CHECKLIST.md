...
<div class="card group">
  <div class="card-content">
    ...
    <p class="card-description">
      Complete guide to UX design career paths, essential skills,
...
### ❌ 忘记添加 slug 到数组
**错误：** 添加了内容块但没有在 `getStaticPaths()` 添加 slug
**结果：** 页面返回 404

### ❌ 标题映射不匹配
**错误：** slug 和 titleMap 的 key 不一致
**结果：** 页面标题显示为 "Default Title"
