...
<NotionLayout title="职位名称" description="职位描述" breadcrumbs={breadcrumbs}>
  <h2>Overview</h2>
  <p>内容...</p>
...
/* 颜色 */
--color-black:
  #000000 --color-text: #37352f --color-text-light: #787774
    --color-white: #ffffff --color-border: #e9e9e7 --color-bg-subtle: #f7f6f3
    /* 字体 */ --font-family-sans: 'Inter',
  -apple-system,
  ... --font-size-sm: 0.875rem --font-size-base: 1rem --font-size-lg: 1.25rem
    --font-size-xl: 2rem /* 间距 */ --space-1: 0.5rem --space-2: 1rem
    --space-3: 1.5rem --space-4: 2rem... /* 布局 */ --container-narrow: 900px
...
**最后更新**: 2024-11-13 **版本**: 2.0.0 (Notion 风格改造)
