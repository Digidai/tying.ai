...
class PositionSearch {
  ...
  getSuggestionIcon(type) {
    const icons = {
      position:
        '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="m22 21-3-3 3-3"></path><path d="m19 18 3-3"></path></svg>',
      skill:
  ...
  handleKeyNavigation(e) {
    ...
    let currentIndex = -1;
    const currentItem = this.suggestionsContainer.querySelector(
      '.suggestion-item.selected, .history-item.selected',
    );
    if (currentItem) {
