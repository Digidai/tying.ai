...
export const companies: FundingCompany[] = [
  {
    name: 'Bindwell',
    round: '$6M · Seed',
    date: 'Nov 13, 2025',
  ...
  },
  {
    ...
    jobs: 'https://www.sundrivesolar.com/careers',
  ...
  },
  {
    ...
    jobs: 'https://www.hippocraticai.com/careers',
  ...
  },
  {
    ...
    date: 'Oct 28, 2025',
    leadInvestor: 'Founders Fund',
    website: 'https://substrate.run/',
    jobs: 'https://substrate.run/careers',
  ...
  },
  {
    ...
    jobs: 'https://datacurve.ai/careers',
    news: 'https://www.businesswire.com/news/home/20251007892341/en/Datacurve-Raises-5M-Seed-to-Solve-the-AI-Data-Bottleneck',
  },
  {
    name: 'Spellbook',
    round: '$50M · Series B',
  ...
  },
  {
    ...
    jobs: 'https://www.quilter.ai/careers',
    news: 'https://techcrunch.com/2025/10/06/quilter-raises-10m-to-automate-circuit-board-design-using-ai/',
  },
  {
    name: 'FurtherAI',
    round: '$25M · Series A',
...
const validationResult = safeValidateFundingCompanies(companies);
if (!validationResult.success) {
  throw new Error(
    `Company data validation failed: ${JSON.stringify(validationResult.error.issues, null, 2)}`,
  );
}
