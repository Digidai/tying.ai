...
export const positions: Position[] = [
  {
    ...
    category: {
      id: 'engineering',
      name: 'Engineering',
      description: 'Product and platform engineering roles',
      icon: '🛠️',
    },
    experience: 'senior',
    salary: {
    ...
    requirements: [
      ...
      'Hands-on experience with distributed systems and ML tooling',
    ],
    responsibilities: [
      'Architect the next generation of the platform runtime',
  ...
  },
  {
    ...
    requirements: [
      ...
      'Ability to translate research into experiments',
    ],
    responsibilities: [
      'Define quarterly OKRs with design and engineering partners',
    ...
    remote: 'hybrid',
    visa: 'potential',
    tags: ['product', 'analytics', 'enterprise'],
  },
  {
    id: 'pos_ds_remote',
    title: 'Staff Data Scientist, Recommendations',
    company: 'Tying.ai',
    location: 'Remote (US)',
    type: 'full-time',
    category: {
      id: 'data',
      name: 'Data Science',
      description: 'Advanced analytics and ML roles',
      icon: '📊',
    },
    experience: 'lead',
    salary: {
    ...
    responsibilities: [
      'Prototype and productionize new ranking algorithms',
    ...
    remote: 'remote',
    visa: 'potential',
    tags: ['data-science', 'recommendations', 'remote'],
  },
  {
    id: 'pos_ux_ldn',
    title: 'Lead UX Designer, Career Journeys',
    company: 'FuturePath',
    location: 'London, UK',
    type: 'full-time',
    category: {
      id: 'design',
      name: 'Design',
      description: 'Product and visual design roles',
      icon: '🎨',
    },
    experience: 'lead',
    salary: {
    ...
    requirements: [
      ...
      'Ability to guide systems thinking',
    ],
    responsibilities: [
      'Establish design principles and rituals',
  ...
  },
  {
    ...
    category: {
      ...
      description: 'Community and advocacy roles',
      icon: '💬',
    },
    experience: 'mid',
    salary: {
    ...
    responsibilities: [
      'Create technical content and reference applications',
    ...
    remote: 'flexible',
    visa: 'no',
    tags: ['devrel', 'javascript', 'advocacy'],
  },
  {
    id: 'pos_ops_sg',
    title: 'Operations Manager, APAC Programs',
    company: 'CareerNest',
    location: 'Singapore',
    type: 'full-time',
    category: {
      id: 'operations',
      name: 'Operations',
      description: 'Business and program operations',
      icon: '📦',
    },
    experience: 'mid',
    salary: {
    ...
    requirements: [
      ...
      'Comfort with CRM and workflow automation tools',
    ],
    responsibilities: [
      'Coordinate onboarding for new partners',
    ...
    remote: 'on-site',
    visa: 'potential',
    tags: ['operations', 'apac', 'partnerships'],
  },
] satisfies Position[];
